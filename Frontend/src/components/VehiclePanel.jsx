...
const VehiclePanel = (props) => {
  ...
  return (
    <div>
        ...
        <div onClick={()=>{props.setconfirmRidePanel(true);props.setVehicleType('car')}} className='flex p-3 border-2 mb-3 active:border-black bg-gray-100 rounded-xl w-full items-center justify-between'>
          ...
          <div className=' w-1/2'>
            ...
            <p className='text-xl font-semibold'>₹ {props.fare?.car}</p>
        </div>
        <div onClick={()=>{props.setconfirmRidePanel(true);props.setVehicleType('motorcycle')}} className='flex p-3 mb-3 border-2 active:border-black bg-gray-100 rounded-xl w-full items-center justify-between'>
          ...
          <div className=' w-1/2'>
            ...
            <p className='text-xl font-semibold'>₹ {props.fare?.motorcycle}</p>
        </div>
        <div onClick={()=>{props.setconfirmRidePanel(true);props.setVehicleType('auto')}} className='flex p-3 border-2 active:border-black bg-gray-100 rounded-xl w-full items-center justify-between'>
          ...
          <div className=' w-1/2'>
            ...
            <p className='text-xl font-semibold'>₹ {props.fare?.auto}</p>
        </div>
